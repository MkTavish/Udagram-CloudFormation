...
Using the CLI. From your integrated Terminal, make sure you have the AWS CLI installed. Run "AWS Configure" to configure your terminal with the IAM user credentials you created earlier, then run "aws cloudformation create-stack --stack-name 'your stack name' --region 'preferred region' --template-body file://'yaml file' --parameters file://'json parameter file'".
